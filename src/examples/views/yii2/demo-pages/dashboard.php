...
// Needed for Chart functional, if not needed, delete
$this->registerJsFile($dirAsset.'/scripts/Chart.min.js', ['depends' => \shandyrov\shards\assetbundles\AdminShardsEndAsset::class]);
$this->registerJsFile($dirAsset.'/scripts/shards-dashboards-chart.1.1.0.js', ['depends' => \shandyrov\shards\assetbundles\AdminShardsEndAsset::class]);
$this->registerJsFile($dirAsset.'/scripts/app/app-blog-overview-chart.1.1.0.js', ['depends' => \shandyrov\shards\assetbundles\AdminShardsEndAsset::class]);
?>
<!-- Small Stats Blocks -->
<div class="row">
            ...
            <div class="card-body p-0">
                <div class="blog-comments__item d-flex p-3">
                    <div class="blog-comments__avatar mr-3">
                        <img src="<?= $dirAsset ?>/images/avatars/1.jpg" alt="User avatar" /> </div>
                ...
                <div class="blog-comments__item d-flex p-3">
                    <div class="blog-comments__avatar mr-3">
                        <img src="<?= $dirAsset ?>/images/avatars/2.jpg" alt="User avatar" /> </div>
                    <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                            <a class="text-secondary" href="#">James Johnson</a> on
                            <a class="text-secondary" href="#">Hello World!</a>
                ...
                <div class="blog-comments__item d-flex p-3">
                    <div class="blog-comments__avatar mr-3">
                        <img src="<?= $dirAsset ?>/images/avatars/3.jpg" alt="User avatar" /> </div>
                    <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                            <a class="text-secondary" href="#">James Johnson</a> on
                            <a class="text-secondary" href="#">Hello World!</a>
